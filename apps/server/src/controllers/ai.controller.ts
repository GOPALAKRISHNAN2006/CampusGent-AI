...
export const getCareerAdvisor = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
    ...
    const userPrompt = `
      Student Profile:
      - Department: ${student.department ? (student.department as any).name : 'Not Specified'}
...
export const getResumeAnalyzer = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
    const userId = req.user?.id;
...
export const getInterviewPrep = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
    const userId = req.user?.id;
...
export const evaluateMockInterview = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
    const userId = req.user?.id;
...
export const uploadResumeAnalyzer = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
    const userId = req.user?.id;
    if (!req.file) {
...
export const executeAgent = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
    const userId = req.user?.id;
